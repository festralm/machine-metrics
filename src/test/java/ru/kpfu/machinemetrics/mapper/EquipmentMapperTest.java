...
public class EquipmentMapperTest {
    ...
    public void testToEquipment() {
        ...
        softly.assertThat(equipment.getId()).isEqualTo(dto.getId());
    ...
    @Test
    public void testToEquipmentDto() {
        // given
        ...
        // when
        EquipmentDto dto = equipmentMapper.toEquipmentDto(equipment);
    ...
    @Test
    public void testToEquipmentDtos() {
        // given
        Equipment equipment1 = Equipment.builder()
                ...
                .responsiblePerson("John Doe")
                .status("Active")
                .receiptDate(Instant.now().minusSeconds(3600))
                .lastOperationDate(Instant.now())
                .deleted(false)
                .build();
        Equipment equipment2 = Equipment.builder()
                ...
                .status("Inactive")
                .receiptDate(Instant.now().minusSeconds(7200))
                .lastOperationDate(Instant.now().minusSeconds(3600))
                .deleted(false)
                .build();
        List<Equipment> equipments = List.of(equipment1, equipment2);

        // when
        List<EquipmentDto> dtos = equipmentMapper.toEquipmentDtos(equipments);
