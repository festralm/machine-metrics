...
@WebMvcTest(EquipmentScheduleController.class)
@ImportAutoConfiguration(MessageSourceConfig.class)
public class EquipmentScheduleControllerTest {
    ...
    public void testCreate() throws Exception {
        ...
        // expect
        mockMvc.perform(post("/api/v1/equipment-schedule")
    ...
    public void testCreateWithEmptyId() throws Exception {
        ...
        String message = messageSource.getMessage("validation.equipment-schedule.id.empty", null, new Locale("ru"));
    ...
    public void testCreateWithEmptyDataServiceId() throws Exception {
        ...
        String message = messageSource.getMessage("validation.equipment-schedule.data-service.empty", null, new Locale(
                "ru"));
        ErrorResponse expectedResponseBody = new ErrorResponse(400, "\"" + message + "\"");
    ...
    public void testCreateWithEmptyCronId() throws Exception {
        ...
        String message = messageSource.getMessage("validation.equipment-schedule.cron.empty", null, new Locale(
                "ru"));
        ErrorResponse expectedResponseBody = new ErrorResponse(400, "\"" + message + "\"");
    ...
    public void testGetExistingEquipmentInfo() throws Exception {
        ...
        // expect
        mockMvc.perform(get("/api/v1/equipment-schedule/{id}", equipmentInfo.getId()))
    ...
    public void testGetNonExistingEquipment() throws Exception {
        ...
        // expect
        mockMvc.perform(get("/api/v1/equipment-schedule/{id}", equipmentInfoId))
